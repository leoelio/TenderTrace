...
class Settings:
    ...
    qualification_min_stakeholder_coverage: int
    ...
    def load(cls, workspace_root: Path | None = None) -> "Settings":
        ...
        return cls(
            ...
            qualification_min_stakeholder_coverage=_parse_percentage(
                _first_value(
                    "TENDERTRACE_QUALIFICATION_MIN_STAKEHOLDER_COVERAGE",
                    env_files,
                    "50",
                ),
                "TENDERTRACE_QUALIFICATION_MIN_STAKEHOLDER_COVERAGE",
    ...
    def safe_summary(self) -> dict[str, object]:
        return {
            ...
            "feishu_bitable_table_configured": bool(self.feishu_bitable_table_id),
            "feishu_bitable_base_url_configured": bool(self.feishu_bitable_base_url),
            ...
            "qualification_policy": {
                ...
                "minimum_stakeholder_coverage": (
                    self.qualification_min_stakeholder_coverage
                ),
